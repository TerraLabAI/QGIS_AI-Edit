...
arc whose hue reflects subscription state and remaining ratio. Replaces
the verbose "1760 / 3000 credits remaining" line in the footer.
"""
...
class CreditRing(QWidget):
    ...
    The widget defaults to 18×18 px which sits cleanly next to 11px footer
